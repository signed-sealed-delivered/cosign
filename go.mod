...
require (
	...
	github.com/buildkite/agent/v3 v3.111.0
...
replace github.com/sigstore/sigstore-go => github.com/signed-sealed-delivered/sigstore-go v0.0.0-20251224181637-0cd667ed4af7
